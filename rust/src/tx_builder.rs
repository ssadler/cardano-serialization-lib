...
impl TransactionBuilder {
    ...
    pub fn add_output(&mut self, output: &TransactionOutput) -> Result<(), JsError> {
        ...
        let min_ada = min_ada_required(&output.amount(), &self.minimum_utxo_val, output.data_hash());
            ...
            Some(Ordering::Greater) => {
                ...
                if has_assets(change_estimator.multiasset()) {
                    ...
                    while let Some(Ordering::Greater) = change_left.multiasset.as_ref().map_or_else(|| None, |ma| ma.partial_cmp(&MultiAsset::new())) {
                        ...
                        let min_ada = min_ada_required(&change_value, &self.minimum_utxo_val,None);
                    ...
                    let min_ada = min_ada_required(&change_estimator, &self.minimum_utxo_val,None);
